...
@{
	...
	RootModule = 'vROpsCloud.psm1'

	# Version number of this module.
	ModuleVersion = '1.0'

	# ID used to uniquely identify this module
	GUID = '44b7bffd-d1d7-4b55-8a71-7fd6299118c1'
	...
	PrivateData = @{
		PSData = @{
			...
			Tags = @("vROps","PowerCLI","RESTAPI","VMware",'Panzerbjrn')

			# A URL to the license for this module.
			# LicenseUri = ''

			# A URL to the main website for this project.
			#ProjectUri = 'https://github.com/Panzerbjrn/'
